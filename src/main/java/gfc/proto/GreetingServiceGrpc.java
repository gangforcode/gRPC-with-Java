...
public final class GreetingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "gfc.proto.GreetingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<gfc.proto.HelloRequest,
      gfc.proto.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = gfc.proto.HelloRequest.class,
      responseType = gfc.proto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<gfc.proto.HelloRequest,
      gfc.proto.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<gfc.proto.HelloRequest, gfc.proto.HelloResponse> getSayHelloMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getSayHelloMethod = GreetingServiceGrpc.getSayHelloMethod) == null) {
          GreetingServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<gfc.proto.HelloRequest, gfc.proto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  gfc.proto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  gfc.proto.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sayHello(gfc.proto.HelloRequest request,
        io.grpc.stub.StreamObserver<gfc.proto.HelloResponse> responseObserver) {
  ...
  public static final class GreetingServiceStub
     ...
     * </pre>
     */
    public void sayHello(gfc.proto.HelloRequest request,
        io.grpc.stub.StreamObserver<gfc.proto.HelloResponse> responseObserver) {
  ...
  public static final class GreetingServiceBlockingStub
     ...
     * </pre>
     */
    public gfc.proto.HelloResponse sayHello(gfc.proto.HelloRequest request) {
  ...
  public static final class GreetingServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<gfc.proto.HelloResponse> sayHello(
        gfc.proto.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((gfc.proto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<gfc.proto.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              gfc.proto.HelloRequest,
              gfc.proto.HelloResponse>(
  ...
  private static abstract class GreetingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return gfc.proto.Hello.getDescriptor();
    }
